        ...
        return (
            <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-violet-50 via-purple-50 to-blue-50 p-4 dark:from-gray-900 dark:via-purple-900/20 dark:to-gray-800">
                <div className="w-full max-w-4xl">
                    ...
                    <div className="rounded-3xl bg-white p-8 shadow-2xl sm:p-12 dark:bg-gray-800 text-center">
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            >
                                <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-violet-100 dark:bg-violet-800/30 transition-transform duration-500 group-hover:scale-150" />
                            ...
                            >
                                <div className="absolute top-0 right-0 -mt-4 -mr-4 h-24 w-24 rounded-full bg-fuchsia-100 dark:bg-fuchsia-800/30 transition-transform duration-500 group-hover:scale-150" />
